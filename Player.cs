    ...
    class Player
    {
        ...
        void AStar()
        {
            ...
            while (pq.Count > 0)
            {
                ...
                // 상하좌우 등 이동할 수 있는 좌표인지 확ㅇ니해서 예약 한다.
        ...
        void CalePathFromParent(Pos[,] parent)
        {
            int y = _board.DestY;
            int x = _board.DestX;
        ...
        void RigthHand()
        {
            //  현재 바라보고 있는 방향으로 기준으로, 좌표 변화를 나타낸다.
            ...
            while (PosY != _board.DestY || PosX != _board.DestX)
            {
                ...
                // 2. 현 재 바라보는 방향을 기준으로 전진할 수 있는지 확인.
